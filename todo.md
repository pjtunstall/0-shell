...
- As for code reviews.
- Revisit question of capitalization patterns in error messages.
...
- Consider structure: e.g. make a `Command` struct with methods `usage`, `run`, etc. to cut down on boilerplate.
